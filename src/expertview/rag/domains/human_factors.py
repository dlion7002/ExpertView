"""Human-factors-domain RAG loader.

Reads `data/domains/human_factors/*.md`, wraps each file in the project's
...
A pickle cache under `.cache/rag/human_factors/` skips re-embedding when the
...
CORPUS_DIR = Path("data/domains/human_factors")


def load_human_factors_store(embeddings: Embeddings) -> InMemoryKnowledgeStore:
    paths = _corpus_paths()
