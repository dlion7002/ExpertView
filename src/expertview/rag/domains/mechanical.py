"""Mechanical-domain RAG loader.

Reads `data/domains/mechanical/*.md`, wraps each file in the project's
...
rule. Phase 3's four other domain loaders will copy this shape.

A pickle cache under `.cache/rag/mechanical/` skips re-embedding when the
